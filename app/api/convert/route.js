...
const LATEX_SYSTEM_PROMPT = `You are a world-class LaTeX typographer and document designer. \
Your task is to convert the provided PDF into a beautifully redesigned, fully compilable LaTeX document \
with exceptional typographic quality. Do NOT merely transcribe — actively IMPROVE the layout and presentation.
        ...
        messages: [
          {
            role: 'user',
            content: [
              { type: 'text', text: 'Convert this PDF to LaTeX. Output only the LaTeX code.' },
